...
<section class="report-detail-hero" id="reportHero">
    @if($report->cover_image)
        <img src="{{ asset($report->cover_image) }}" alt="{{ $report->title }}" id="parallaxImg">
    @else
    ...
    <div class="report-detail-hero-content reveal reveal-up">
        ...
        <div class="blog-meta" style="justify-content:center;">
            ...
            @if($settings['owner_name'] ?? null)<span>•</span><span>{{ $settings['owner_name'] }}</span>@endif
    ...
    <div class="report-attachments reveal reveal-up">
        ...
        @foreach($report->attachments as $attachment)
            <div class="attachment-item">
                ...
                <a href="{{ asset($attachment) }}" download class="report-download-btn">
