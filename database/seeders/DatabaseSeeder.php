...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // --- Portfolios ---
        Portfolio::create([
            'title' => 'Cyberpunk Mecha Robot — Blender 3D Sculpt',
            'category' => '3D',
            'description' => 'A high-detail cyberpunk mecha robot model created in Blender 4.0 with Cycles rendering. Features PBR materials, intricate mechanical joints, and neon emissive accents.',
        ...
        Portfolio::create([
            ...
            'category' => 'ML',
            'description' => 'A deep learning project implementing CNN architecture for image classification on the CIFAR-10 dataset, achieving 92% test accuracy with data augmentation and transfer learning.',
        ...
        Portfolio::create([
            'title' => 'Real-Time Chat Application with Laravel & WebSocket',
            'category' => 'Programming',
            'description' => 'A full-stack real-time chat application built with Laravel 11, Laravel Reverb for WebSocket communication, and a responsive Vue.js frontend. Supports private rooms, typing indicators, and message history.',
